 ...
 * @author Davide
 */
public final class PicPuzzle extends Panel implements MouseListener{

    public static BufferedImage pic;        // Picture
    public int pieceW, pieceH;              // Width and Height of pieces
    
    //settings
    public int pieceNumX = 4;
    public int pieceNumY = 4;
    ...
    public PicPuzzle()
    {
        ...
        try
        {
            ...
            if ("u".equals(input))
                pic = ImageIO.read(new URL("http://www.google.de/images/srpr/logo3w.png"));
            else if ("f".equals(input))
                pic = ImageIO.read(new File("images\\logo.jpg"));
            else
                System.exit(-1);
        } 
   ...
   public static Dimension getPicSize()
   {
    ...
    public static void main(String[] args) {
        ...
        // GAME PANEL
        Panel pan = new PicPuzzle();
                
        final PicPuzzle Puzzle = (PicPuzzle)pan;
        pan.setPreferredSize(PicPuzzle.getPicSize());      
        frame.add(pan);
